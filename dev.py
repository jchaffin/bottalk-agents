...
async def start(request: dict | None = None):
    ...
    # In local dev, frontend SSE consumers read from Next.js /api/metrics.
    # Force agent dashboard posts to frontend rather than this FastAPI server.
    child_env["DASHBOARD_URL"] = "http://localhost:3000"
